...
public:
    ...
    bool lowLimitWarningCheck(float value, int min, int minwarn);
    bool highLimitWarningCheck(float value, int max, float maxwarn);
...
public:
    ...
    int valuesIsInWarningRange(float value, float min, float max, float minwarn, float maxwarn)
    {
        ...
        if(lowLimitWarningCheck(value,min,minwarn))
        {
            return LOW_LIMIT_WARNING;
        }
        if(highLimitWarningCheck(value,max,maxwarn))
        {
            return HIGH_LIMIT_WARNING;
        }
    }
    
    bool lowLimitWarningCheck(float value, float min, float minwarn)
    {
    ...
    bool highLimitWarningCheck(float value, float max, float maxwarn)
    {
